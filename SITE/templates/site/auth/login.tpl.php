...
<div class="container">
<div class="row"> 
<div class="col-lg-3 box animated">  
<form method="POST">
  <h2 class="font" style="cursor: default;">Entrar</h2>
<div class="inputBox">
...
<button type="submit" class="btn btn-warning button center-block" ><i class="fas fa-sign-in-alt"></i> Entrar </button><br><center> 
